import {
   ...
   , Output, Renderer2, ViewEncapsulation
} from "@angular/core";
import { EventData, dataTransfer } from "@mobilize/base-components";
import {
   UserControlComponent, WebComponentsService
} from "@mobilize/winforms-components";
import { WebMapService, NotifyChange } from "@mobilize/angularclient";
@Component({
   selector: "hiring-tracking-site-position-details-form",
   styleUrls: ["./position-details-form.component.css"],
   templateUrl: "./position-details-form.component.html",
   encapsulation: ViewEncapsulation.None
})
@dataTransfer(["frmHiringTrackingSitePositionDetailsForm"])
export class PositionDetailsFormComponent extends UserControlComponent {
